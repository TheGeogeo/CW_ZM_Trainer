...
namespace CW_Beach
{
    ...
    {
        //-------------------------------------------------Adress update 1.20.1----------------------------------------------------

        public static IntPtr PlayerBase = (IntPtr)0x1147D748; //G_Client
        public static IntPtr CMDBufferBase = (IntPtr)0xDA008B0;
        public static IntPtr XPScaleBase = (IntPtr)0x114AD738;
